...
<form id="Canvas" name="formGCS"  action="<?php echo URL."dashboard/mlegale1/".$this->user[0]['id'];?>"  method="POST">	
	...
	$fichier1 = URLCANVAS."mlegale/".$this->user[0]['id'].'.jpg' ;
	if (file_exists($fichier1)){$fichier = URL."public/images/mlegale/".$this->user[0]['id'].'.jpg?t='.time();}else {$fichier = URL."public/images/mlegale/mlegale.jpg?t=".time();}
	echo  '<img  width="800" height="500"  style="border:2px solid green;" src="'.$fichier.'"> ';
	echo '</div>';
...
<div class="contenth"><img id="image" src="<?php echo URL;?>public/images/mlegaleicon.jpg" ></div>	
<div class="contentx">
...
echo'<script type="text/javascript" src="'.URL.'public/js/JsCode1.js?t='.time().'&q='.$this->user[0]['id'].'"></script>';
?>
