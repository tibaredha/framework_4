...
<div class="sheader2l"><?php $sError='Produire un fichier excel du '.$this->d1.' au '.$this->d2.'';echo $sError;  ?></div>

<div class="sheader2r">***********</div>
<div class="contentl">
<div id="inner-grid">
			<div id="a"><?php $this->clgdatabse->XLS($_SERVER['SERVER_NAME'],Session::get('structure'),$this->d1,$this->d2);  ?></div>
			<div id="b">Sauvegarde terminée</div>
			<div id="c"><?php echo 'Du '.$this->d1; echo ' Au'.$this->d2;  ?></div>
			<div id="d"><?php echo '<a href="'.URL.'xls/D_'.Session::get('structure').'_'.$this->d1.'_au_'.$this->d2.'.xls">1-Enregistrer Sous (*.xls)</a></br>'; ?></div>
			<div id="e"><?php echo '<a href="'.URL.'xls/D_'.Session::get('structure').'_'.$this->d1.'_au_'.$this->d2.'.xlsx">2-Enregistrer Sous (*.xlsx)</a></br>';	  ?></div>
			<div id="f"></div>
