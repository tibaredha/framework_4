...
<div class="sheader1l"><?php Session::init();if(isset($_SESSION['errorlogin'])){$sError = '<p id="errorlogin">'.$_SESSION['errorlogin'].'</p>';echo $sError;}else {$sError='<p id="llogin">Gérer les certificats de décès</p>';echo $sError;}?></div>
<div class="sheader1r"><p id="llogin"><?php html::NAV();?></p></div>
<div class="sheader2l"><?php $sError='Evaluation Mortalité hospitalière du '.$this->d1.' au '.$this->d2.'';echo $sError;  ?></div>
