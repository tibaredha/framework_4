...
<div class="contentl">
	...
	echo '<div id="content_1" class="contenttabs1">';
		echo '<Ol>';
			...
			echo '<li>';echo '<a href="'.URL.'fpdf/doc/EPH_EPSP.pdf">D_exécutif N°07-140 du 19-05-2007 portant création des EPH et des EPSP.pdf</a>';echo '&nbsp;';echo '</li>';
			...
			echo '<li>';echo '<a href="'.URL.'fpdf/doc/F2014039.pdf">Instruction_declaration_obligatoire _deces_maternel.page 31</a>';echo '&nbsp;';echo '</li>';
