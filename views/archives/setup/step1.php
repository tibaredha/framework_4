...
<div class="sheader2l">2-EULA</div>
<div class="sheader2r">{$MSPRH}</div>
<div class="contentl">
	<div >You must accept the EULA to continue!</div>
	<textarea class="info" style="height: 350px; width: 100%;">
	{$eula}
	</textarea>
	<form action="{$URL}setup/step2" method="post">			
...
<div class="content"> <img id="image" src="{$URL}public/images/EULA.jpg"></div>
