...
"mois"     => array($this->user[0]['mois']=>$this->user[0]['mois'],"Janvier"=>"1","Fevrier"=>"02","Mars"=>"03","Avril"=>"04","Mai"=>"05","Juin"=>"06","Juillet"=>"07","Aout"=>"08","Septembre"=>"09","October"=>"10","Novombre"=>"11","Decembre"=>"12"),
