...
<?php
		...
		echo'<table>';
			...
			echo '<td align="center" style="width:10px;" bgcolor="#32CD32" ><a target="_blank" title="bnm"  href="'.URL.'fpdf/bnm/fbnm.php?uc='.$value['id'].'" ><img src="'.URL.'public/images/b_props.png"   width="16" height="16" border="0" alt=""   /></a></td>';
		...
		$this->clgraphe->bnmgraphe(30,340,'Nombre de Bordereau Numerique Mensuel par annee Recus du mois de : ','bordereau','annee','SEXE5','M',date("m")) ;
		echo "</div>";
...
<?php 
	...
	echo '<a href="'.URL.'bnm/graphe/0">Année</a>';echo '&nbsp;'; 
?>			
</div>		
<div class="scontentl3">
<?php 
for ($i = 1; $i <= 12; $i+= 1){
echo '<a href="'.URL.'bnm/graphe/'.$i.'">Mois:['.$i.']</a>';echo '&nbsp;';	
}
?>
</div>
