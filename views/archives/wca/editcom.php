...
#WILAYA2,#communefr,#communear,#pop2018,#yes {background: yellow; text-align: center;border-radius: 5px;width: 50%;height: 100%;}
...
echo '<div class="contentl">';?>
	...
	<form  action="<?php echo URL."wca/editSave/".$this->user[0]['IDCOM'];?>"  method="post"    >
	 <div id="inner-grid">  
	        ...
	        <div id="e">Commune yes : <input  type="text" id ="yes"       name="yes"       value="<?php echo $this->user[0]['yes'];?>"/>   </div> 
